...
class Materia(models.Model):
    ...
    professor = models.ForeignKey("contato.Contatoprofessor", on_delete=models.CASCADE, blank=True, null=True, verbose_name="Professor", help_text="Selecione o professor da materia")
